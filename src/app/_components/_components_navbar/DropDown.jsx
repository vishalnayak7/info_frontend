...
export default function DropDown({ setIsOpen, isOpen, dropData, handleMouseLeave }) {
     return (

          <div onMouseLeave={handleMouseLeave} className={`  absolute ${isOpen ? 'translate-y-0 ' : 'translate-y-[-120%]  '}  overflow-hidden duration-300  text-blackish-600 bg-whiteish-500 z-50   py-6  w-full  h-[300px] `}>
               ...
               <div className="    max-w-screen-2xl  w-[87%] md:w-[85%]  flex flex-row justify-between items-start duration-100 z-50 left-0   mx-auto ">
                    ...
                    <div className=" w-[65%]  grid grid-cols-2 gap-12 ">
                         <div className=" space-y-4">
                              ...
                              <h2 className=" text-[26px] font-bold font-manrope mb-1">Today's Pick</h2>

                              <div className=" w-full  leading-[110%] relative flex justify-between flex-row">
                                   <Link href="/blog/slug-s-sdfas-sd" className="font-semibold hover:underline hover:underline-offset-2  w-[93%]   text-black/60 text-[16px] font-manrope ">
                                        Ensures the dropdow n stays belown stays below without messing up.
                                   </Link>
                                   <ArrowUpRight size={20} className="" />
                              </div>
                              <div className=" w-full  leading-[110%] relative flex justify-between flex-row">
                                   <Link href="/blog/slug-s-sdfas-sd" className=" font-semibold hover:underline hover:underline-offset-2 w-[93%]    text-black/60 text-[16px] font-manrope  ">
                                        Ensures the dropdown stays below without  up.
                                   </Link>
                                   <ArrowUpRight size={20} className="" />
                              </div>
                              <div className=" w-full  leading-[110%] relative flex justify-between flex-row">
                              ...
                              <div className=" w-full  leading-[110%] relative flex justify-between flex-row">
                                   <Link href="/blog/slug-s-sdfas-sd" className=" font-semibold hover:underline hover:underline-offset-2 w-[93%]    text-black/60 text-[16px] font-manrope  ">
                                        Ensures the dropdown stays below without messing up.
                                   </Link>
                                   <ArrowUpRight size={20} className="" />
                              </div>
